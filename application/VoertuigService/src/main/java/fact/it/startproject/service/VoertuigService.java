...
public class VoertuigService {
    ...
    @Transactional
    public void addVoertuig(VoertuigRequest voertuigRequest) {
        VoertuigModel voertuig = new VoertuigModel();
        voertuig.setVoertuigCode(voertuigRequest.getVoertuigCode());
        voertuig.setFree(voertuigRequest.isFree());
        System.out.println("Service: " + voertuig.toString());
        voertuigRepository.save(voertuig);
    }

    @Transactional
    public void deleteVoertuig(String voertuigCode) {
        voertuigRepository.findByVoertuigCode(voertuigCode)
                .ifPresent(voertuigRepository::delete);
    }
}
