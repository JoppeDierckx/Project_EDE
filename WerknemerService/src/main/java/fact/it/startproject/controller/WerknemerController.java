...
public class WerknemerController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void updateWerknemer(@PathVariable String phoneNumber, @RequestBody WerknemerRequest werknemerRequest) {
        werknemerService.updateWerknemer(phoneNumber, werknemerRequest);
    }
}
